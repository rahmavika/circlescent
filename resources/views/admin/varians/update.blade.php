        ...
        <div class="card-body d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <small class="text-muted">
                    Perbarui informasi varian parfum
                </small>
            </div>
    ...
    <div class="row justify-content-center">
        <div class="col-xl-8 col-lg-10">
            ...
            <div class="varian-card">
                ...
                <form action="{{ route('dashboard-varian.update', $varian->id) }}"
                    method="POST">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <select
                                ...
                                @foreach($produks as $produk)
                                    <option
                                        value="{{ $produk->id }}"
                                        {{ old('produk_id', $varian->produk_id) == $produk->id ? 'selected' : '' }}>
                                        {{ $produk->nama_produk }}
                                    </option>
                                @endforeach
                        ...
                        <div class="col-md-6">
                            ...
                            <select
                                ...
                                <option value="Exclusive"
                                    {{ old('level', $varian->level) == 'Exclusive' ? 'selected' : '' }}>
                                    Exclusive
                                </option>

                                <option value="Premium"
                                    {{ old('level', $varian->level) == 'Premium' ? 'selected' : '' }}>
                                    Premium
                                </option>

                                <option value="VIP"
                                    {{ old('level', $varian->level) == 'VIP' ? 'selected' : '' }}>
                                    VIP
                                </option>

                                <option value="VVIP"
                                    {{ old('level', $varian->level) == 'VVIP' ? 'selected' : '' }}>
                                    VVIP
                                </option>
                        ...
                        <div class="col-md-6">
                            ...
                            <select
                                ...
                                <option value="30ml"
                                    {{ old('ukuran', $varian->ukuran) == '30ml' ? 'selected' : '' }}>
                                    30ml
                                </option>

                                <option value="50ml"
                                    {{ old('ukuran', $varian->ukuran) == '50ml' ? 'selected' : '' }}>
                                    50ml
                                </option>

                                <option value="100ml"
                                    {{ old('ukuran', $varian->ukuran) == '100ml' ? 'selected' : '' }}>
                                    100ml
                                </option>
...
.btn-save{
    background:
        linear-gradient(135deg,#b8924f,#d4af37)!important;
    color:#111 !important;
    border:none !important;
    border-radius:18px;
    padding:14px 28px;
